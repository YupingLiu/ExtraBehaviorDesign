...
namespace ExtraBehaviorDesign.Runtime.Tasks
{
    ...
    public class Sequence : Composite
    {
        ...
        {
            // We can continue to execute as long as we have children that haven't been executed and no child has returned failure.
        ...
        {
            // Set the current child index to the index that caused abort
