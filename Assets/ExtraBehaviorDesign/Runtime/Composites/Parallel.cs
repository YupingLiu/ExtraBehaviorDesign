...
namespace ExtraBehaviorDesign.Runtime.Tasks
{
    ...
    public class Parallel : Composite
    {
        ...
        {
            // One of the children has started to run. 
            executionStatus[childIndex] = TaskStatus.Running;
            // Increment the child index and set the current task status of that child to running.
            currentChildIndex++;
        }
        ...
        public override void OnChildExecuted(TaskStatus childStatus)
        {
            ...
            executionStatus[currentChildIndex] = childStatus;
        }
